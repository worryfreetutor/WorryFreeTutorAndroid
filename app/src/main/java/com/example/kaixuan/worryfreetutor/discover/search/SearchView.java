...
public class SearchView extends LinearLayout {
        ...
        et_search.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if(keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN){
                    ...
                    if (!(sCallBack == null)){
                        sCallBack.SearchAciton(et_search.getText().toString());
                    }
    ...
    private void queryData(String tempName){
        ...
        adapter = new SimpleCursorAdapter(context,android.R.layout.simple_list_item_1,cursor,new String[]{"name"}, new int[]{android.R.id.text1},CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
     ...
     * 点击键盘中搜索键后的操作，用于接口回调
     */
    public void setOnClickSearch(SCallBack mCallBack){
        this.sCallBack = mCallBack;
